    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Valores */}
          <section className="mb-16">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center animate-fade-in-up">Nuestros Valores</h2>
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div 
                  key={index}
                  className="text-center p-6 bg-gray-50 rounded-xl animate-fade-in-up"
                  style={{ animationDelay: `${index * 200}ms` }}
                >
                  <div className="w-16 h-16 bg-gray-900 rounded-full flex items-center justify-center mx-auto mb-4">
                    {item.number ? (
          ...
          {/* Contacto */}
          <section className="bg-gray-50 rounded-2xl p-8 text-center animate-fade-in-up">
